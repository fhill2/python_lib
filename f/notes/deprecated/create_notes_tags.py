#!/usr/bin/python
# May 2023: I Implemented this into NoteLibrary() class

# LAUNCH THIS SCRIPT WHEN OPENING FZF TAGS - FZF Tag opens ~/tmp/notes-tags
# reads all YAML frontmatter tags from all notes within NOTES_ROOT
# for every notes, creates a symlink under TAG_DIR/<tag_name>/note

# filesystem tags and then compare with library tags - compare dicts
